...
for bug_img in ["bug_1.jpg", "bug_2.jpg", "bug_3.jpg", "bug_4.jpg"]:
    if not os.path.exists(bug_img): continue
    ...
    print(f"\n==================== Analysis of {bug_img} ====================")
    print(f"Board Box: [{l}, {t}, {r}, {b}], size={r-l}x{b-t}, img_shape={img.shape}")
    print(f"Occupied count: {len(occupied)}")
